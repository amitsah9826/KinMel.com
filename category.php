...
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title"><img src="menu.gif" alt="Flowers in Chania" width="35" height="35">Category</h4>
	</div>
...
<video width="280" height="500" controls autoplay muted loop >
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/ca.png" alt="" class="img-responsive">
			</div>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="265" height="320"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
