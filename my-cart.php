...
html,body{
  ...
  width: 100%;
  place-items: center;
  background: linear-gradient(315deg, #red 8%, #d7e1ec 200%);
}
.wrapper{
  display: inline-flex;
}
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<span class="estimate-title">Shipping Address	<img src="add12.png" alt="Flowers in Chania" width="45" height="50"></span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Billing Address          <img src="asddfaaff.png" alt="Flowers in Chania" width="40" height="50"></span>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-success">PROCCED TO CHEKOUT</button>
...
button:hover {
box-shadow: 0 0 5px #0FFF50,
0 0 20px #0FFF50, 0 0 30px #0FFF50,
0 0 50px #0FFF50, 0 0 100px #0FFF50;
}
<style>