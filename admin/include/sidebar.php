...
<ul class="widget widget-menu unstyled">
							<li>
								<a class="collapsed" data-toggle="collapse" href="#togglePages""<body style="background-color:#ffff00;">
...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="insert-product.php""<body style="background-color:#ffe4e1;"><i class="menu-icon icon-paste"></i>Insert Product </a></li>
                                <li><a href="manage-products.php""<body style="background-color:#ffe4e1;"><i class="menu-icon icon-table"></i>Manage Products </a></li>
