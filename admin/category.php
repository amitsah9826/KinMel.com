...
<div class="controls">
<input type="text" placeholder="Bibek Enter Category Name"  name="category" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8"placeholder="Specification लेख्नुहोस्।"  name="description" rows="5"></textarea>
											</div>
										</div>
